...
/**
  * INSTALLATION
  */
1) Navigate to the admin/modules page and turn on both the Pushtape UI and Pushtape Discography modules.
2) Go to node/add/track to start by adding a track.
3) Go to /releases to see a list of recently added albums and single tracks. You can also see 
